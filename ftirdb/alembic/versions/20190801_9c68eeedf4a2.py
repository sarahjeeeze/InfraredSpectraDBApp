...
Revision ID: 9c68eeedf4a2
Revises: 
Create Date: 2019-08-01 18:12:38.404656
...
def upgrade():
    ...
    sa.Column('smiles_inchi_mol2', sa.String(length=300), nullable=True),
    sa.Column('chemical formula', sa.String(length=300), nullable=True),
    ...
    sa.Column('experiment_description', sa.String(length=300), nullable=True),
    ...
    sa.Column('multi-well_plate', sa.Enum('yes', 'no', ''), nullable=True),
    ...
    sa.Column('descriptive_name', sa.String(length=500), nullable=True),
    ...
    sa.Column('protein_common_name', sa.String(length=300), nullable=True),
    sa.Column('alternative_names', sa.String(length=300), nullable=True),
    sa.Column('source_organism', sa.String(length=300), nullable=True),
    sa.Column('uniprot_ID', sa.String(length=300), nullable=True),
    sa.Column('sequence', sa.String(length=300), nullable=True),
    sa.Column('expression_system_or_natural_source', sa.String(length=300), nullable=True),
    sa.Column('expressed_as', sa.String(length=300), nullable=True),
    sa.Column('post_translational_modifications', sa.String(length=300), nullable=True),
    sa.Column('mutation_details', sa.String(length=300), nullable=True),
    sa.Column('expression_tags', sa.String(length=300), nullable=True),
    ...
    sa.Column('experiment_ID', mysql.INTEGER(display_width=11), nullable=True),
    sa.Column('publication_name', sa.String(length=1000), nullable=True),
    ...
    sa.Column('instrument_manufacturer', sa.String(length=300), nullable=True),
    sa.Column('instrument_model', sa.String(length=300), nullable=True),
    ...
    sa.Column('reflectance_device', sa.String(length=300), nullable=True),
    sa.Column('slide_material', sa.String(length=300), nullable=True),
    sa.Column('angle_of_incidence', sa.String(length=300), nullable=True),
    sa.Column('spectrometer_ID', mysql.INTEGER(display_width=11), nullable=True),
