...
Version: v1.0
Date: 10.09.2018
Function: provides view functions for creating a new account and viewing user account information
...
@view_config(route_name='add_account',
             renderer='../templates/addAccount.jinja2')
def view_results(request):
    """ function called when controler wants to create a new account - takes input from a form
